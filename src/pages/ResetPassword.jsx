...
//     <>
//       {success && (
//         <div className="fixed top-5 right-5 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2">
//           <span>✓</span>
//           {success}
//         </div>
//       )}
...
//       {error && (
//         <div className="fixed top-5 left-5 bg-red-500 text-white px-6 py-3 rounded-lg shadow-lg">
//           {error}
//         </div>
//       )}
...
//         style={{ backgroundImage: `url(${background})` }}
//       >
//         <div className="bg-gray-900 w-115 p-8 rounded-2xl shadow-2xl text-center">
...
//             <div className="flex items-center bg-[#1e293b] mt-6 px-4 py-2 rounded-full">
//               <MdLockOutline className="text-gray-400 text-lg mr-3" />
//               <input
//                 type="password"
